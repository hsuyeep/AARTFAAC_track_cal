...
are caused by the presence of actual, unmodeled sources. ]{\includegraphics[width=1\columnwidth]{Figs/model_efficacy} }\subfloat[Model error as a function of point source model complexity.]{\includegraphics[width=1\columnwidth]{Figs/ph_err_54873657_cumsum}}
...
\begin{figure*}[tbh]
`\center{\includegraphics[width=0.7\paperwidth,height=7cm]{Figs/cmpcalsol}}\caption{\label{fig:The-error-timeseries}The error timeseries of tracking
