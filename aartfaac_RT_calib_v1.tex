...
The  former effects  are  usually slowly  varying  ($\sim$hours), are  direction
...
sources within the field.  For DDE parameter estimation, we assume that the DDEs
are  identical  for  all  antennas,  simplifying their  estimation.  This  is  a
resonable assumption  for a compact  array, whose size projected  to ionospheric
heights are  expected to  be smaller than  the typical isoplanatic  patch. Thus,
identical lines  of sight from individual  antennas are expected  to traverse an
ionospheric  patch  with  the  same  refractive  properties.   Hence,  transient
monitors are typically wide-field compact arrays.
...
side-lobe confusion  noise contribution to  the rest of  the image via  the PSF.
...
false  positives.   Thus,  real-time  calibration is  necessary  for  maximizing
...
\hline 
\end{tabular}}
\tablefoot{The $S_{60}$ flux has been derived from modeled spectra.
...
\begin{figure}[tbh]
\includegraphics[width=1\columnwidth]{Figs/tracking_cal_schematic_new.png}
...
\hline 
1. & 2011-Sep-21, 1200-1500 UTC & 5s & 3 kHz & 64{*}5 & 60 MHz & Active Sun \\ % \tabularnewline
% \hline 
2. & 2012-Jul-12, 2222-2258 UTC & 1s & 3 kHz & 64{*}5 & 60 MHz & Slow scintillation\\ %\tabularnewline
% \hline 
3. & 2012-Jul-12, 0140-0200 UTC & 1s & 3 kHz & 64{*}5 & 60 MHz & Rapid scintillation\\ %\tabularnewline
% \hline 
4. & 2012-Jul-12, 0340-0430 UTC & 1s & 3 kHz & 64{*}5 & 60 MHz & Local dawn\\ %\tabularnewline
\hline 
\end{tabular}}
\end{table*}
...
\begin{figure}[tbh]
%% \centering
\includegraphics[width=1\columnwidth]{Figs/major_minor_cycle_conv.eps}
...
\begin{figure}[tbh]
\includegraphics[width=1\columnwidth]{Figs/cmpcalsol.eps}
...
variation in  the extracted flux  is due to  systematic variations on  the short
scale, most probably  caused by the ionosphere.   This limits the estimation
accuracy on the extracted light-curve.

\begin{figure*}[tbh]
\includegraphics[width=1\columnwidth]{Figs/SB002_LBA_OUTER_SPREAD_1ch_6_convcal_7_el_fftimg_bin_save_mat_tseries.eps}
...
spatial scales  ($\sim0.1\%$ variations  over a few  kilometer and over  tens of
...
defocussing, resulting in a reduction of the source peak flux.
...
the field of view of each antenna.
...
\textbf{Time/spectral bin for calibration:} The time and spectral binning of the
...
a fractional bandwidth of $10^{-3}$ puts  a limit of $\sim48 kHz$ on the channel
