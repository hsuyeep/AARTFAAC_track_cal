...
\abstract{ The  search for transient phenomena  at low radio  frequencies is now
  ...
  made feasible by new developments in calibration algorithms and computing.  At
  the forefront of this effort is the Amsterdam-ASTRON Radio Transients Facility
  And  Analysis Center  (AARTFAAC)  array, a  sensitive, continuously  available
  all-sky monitor based on the Low Frequency Array (LOFAR) which will operate in
  a zenith pointing, snapshot imaging mode.  This paper describes a strategy for
  the real-time  calibration of the  AARTFAAC widefield synthesis  imaging array
  for  image plane detection  of Radio  transients.  We  lay down  the operating
  constraints on the  instrument considering the nature of  the application, and
  discuss  their  implications  on  the  calibration  approach.   We  find  that
  ionosphere induced phase errors present  a major impediment in calibrating the
  instrument, and influence the calibration strategy.  We describe our approach
  in detail,  and present  a quantitative evaluation  of the performance  of our
  calibration strategy  under actual  instrumental and observing  conditions. We
  find a  tracking calibration approach with solution  propagation satisfies our
  time,  computing  and  fidelity  constraints.   Autonomously  calibrating  and
  imaging snapshots of a second, our  approach leads to an image noise typically
  \textasciitilde{}TODOx higher than the thermal limit.}
