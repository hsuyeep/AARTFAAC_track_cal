...
\abstract{ The  search for transient phenomena  at low radio  frequencies is now
  ...
  However, accurate calibration of such arrays is challenging, especially due to
  the  large  field   of  view,  and  is  the  main   cause  of  limiting  their
  sensitivities.   This paper  describes  a strategy  for real-time,  wide-field
  ...
  difference imaging  allows thermal noise limited  transient detection, despite
  the instrument being confusion noise limited.}
...
\subsubsection{SelfCal Constraints}
...
a snapshot from Table ,set 3. The $S_{60}$ flux has been derived from modeled spectra.
