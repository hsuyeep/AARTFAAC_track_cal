...
\begin{figure}[tbh]
  \resizebox{\hsize}{!}{\includegraphics{Figs/model_efficacy.eps}} 
  \caption{Sky model efficacy for selfcalibration on a single timeslice}
  \label{fig:The-model-amplitude}
\end{figure}

\begin{figure}[tbh]
  \resizebox{\hsize}{!}{\includegraphics{Figs/selfcal_phase_behaviour.png}} 
...
\begin{figure}[tbh]
\resizebox{\hsize}{!}{\includegraphics[width=1\columnwidth]{Figs/raw_vs_diff_vs_theory}}
